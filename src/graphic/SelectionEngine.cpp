...
SelectionResult SelectionEngine::pickPoint(const QPointF& worldPoint, bool addToSelection)
{
...
SelectionResult SelectionEngine::pickRect(const QRectF& worldRect, bool addToSelection)
{
    SelectionResult result;
